...
const EditDialog = ()=>{
    ...
    const onsubmit = async (data: UserType)=>{
        ...
        try{
            ...
            if(data?.description && data.description!==userInfo.description) payload.description=data.description
            if(file) {
    ...
    return(
        <Dialog open={openDialog} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild className='flex gap-2 items-center'>
                <Button variant={"ghost"}><Pen size={15}/>Edit Profile</Button>
            </DialogTrigger>
            <DialogContent>
                <DialogHeader>
                ...
                >
                    ...
                    <div className='w-full flex items-center justify-center relative'>
                        <Avatar className='w-50 h-50'>
                            <AvatarImage src={preview || userInfo?.avatar || undefined } className='object-cover'/>
                    ...
                    <div className='flex justify-between items-center gap-5'>
                        ...
                        <Pen size={20} onClick={()=>setEditing(editing!="description" ? "description":"" )}/>
                    </div>
                    {/* Email */}
                    <div className='flex justify-between items-center gap-5'>
                    ...
                    <div className='flex justify-between items-center gap-5'>
                        ...
                        <Pen size={20} className='' onClick={()=>setEditing(editing!="phone" ? "phone":"")}/>
                    </div>
                    {/* Birthday */}
                    <div className='flex justify-between items-center gap-5'>
...
const ProfileMe = () => {
    ...
    return authLoading ? <SkeletonProfile /> : isAuth ? (
      <div className='container flex flex-col px-10 py-5 justify-between gap-2'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <ul className='flex flex-col gap-2'>
            ...
            {userInfo?.dob && <li>Birthday: {new Date(userInfo?.dob).toLocaleDateString('vi-VN')}</li>}
          </ul>
        </div>
        <div className='flex flex-col gap-2'>
